                    ...
                    <form action="Sanpham.php" method="get">
                        <div class="facet-group">
                            ...
                            <div id="facet-body-categoryid" class="facet-body">
                                <select name="price_space" id="input_filter_price_space" class="select2" value="<?php if (isset($_GET['Gia'])) {
                                                                                                                    echo $_GET['Gia'];
                                                                                                                } ?>">
                        ...
                        <div class="facet-group">
                            ...
                            <div class="facet-body">
                                <select name="attrs[]" class="select2" id="input_filter_brand" tabindex="0" aria-hidden="false" value="<?php if (isset($_GET["Idthuonghieu"])) {
                                                                                                                                            echo $_GET["Idthuonghieu"];
                                                                                                                                        } ?>">
                                    <option class="list_filter_title toggleCtl change_btn_minus" value="">-- Tất cả --</option>
                        ...
                        <div class="facet-group">
                            ...
                            <div class="facet-body">
                                <select name="attrs[]" class="select2" id="input_filter_volume" tabindex="0" aria-hidden="false" value="<?php if (isset($_GET["Dungtich"])) {
                                                                                                                                            echo $_GET["Dungtich"];
                                                                                                                                        } ?>">
                                    <option class="list_filter_title toggleCtl change_btn_minus" value="">-- Tất cả --</option>
                                    <option value="0-499">
                        ...
                        <div class="input-group">
                            <input type="search" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" name="search1" value="<?php if (isset($_GET["serach1"])) {
                                                                                                                                                                                    echo $_GET["serach1"];
                                                                                                                                                                                } ?>">
