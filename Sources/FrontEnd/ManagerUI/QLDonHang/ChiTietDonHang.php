        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.TrangThai == 'Huy') {
                    ...
                    var addCompleted = document.getElementsByClassName("order_status");
                    if(data.TrangThai == 'DaDuyet'){
                        addCompleted[1].classList.add("completed");
                    }
                    else if(data.TrangThai == 'DangGiao'){
                        addCompleted[1].classList.add("completed");
                        addCompleted[2].classList.add("completed");
                    }
                    else if(data.TrangThai == 'GiaoThanhCong'){
                        addCompleted[1].classList.add("completed");
                        addCompleted[2].classList.add("completed");
                        addCompleted[3].classList.add("completed");
                    }
                }
